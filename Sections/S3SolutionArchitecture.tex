...
% \begin{figure} [!htbp]
% \centering    
% \subfigure[Demand Curve for CashCoin]{\label{fig31}\includegraphics[width=\linewidth]{dcfc.png}}
% \subfigure[Change in demand for CashCoin]{\label{fig32}\includegraphics[width=\linewidth]{cidfc.png}}
% \caption{Dynamics of CashCoin}
% \end{figure}
...
% \begin{figure} [!htbp]
% \centering    
% \subfigure[Demand Curve for BondCoin]{\label{fig33}\includegraphics[width=\linewidth]{dcfb.png}}
% \vspace{1cm}
% \subfigure[Change in demand for BondCoin]{\label{fig34}\includegraphics[width=\linewidth]{cidfb.png}}
% \caption{Dynamics of BondCoin}
% \end{figure}
